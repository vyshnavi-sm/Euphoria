...
const getDashboardData = async (req, res) => {
  try {
    ...
    const [salesChartData, weeklyData, monthlyData, yearlyData] =
      await Promise.all([
        Order.aggregate([
          {
            $match: {
    ...
    const filledSalesData = fillDataPoints(
      salesChartData,
      30,
    ...
    const filledWeeklyData = fillDataPoints(
      weeklyData,
      12,
      (date) =>
    ...
    const filledMonthlyData = fillDataPoints(
      monthlyData,
      12,
      (date) =>
    ...
    const filledYearlyData = fillDataPoints(
      yearlyData,
      5,
